      ...
      <div className="py-5">
        <div className="container">
          <h2 className="text-center mb-5">
            Why Participate in the Unilroin INSPIRE Award?
          </h2>
          <div className="row">
        ...
        <div className="container">
          <div className="row d-flex align-items-center justify-content-around">
            <div className="col-lg-5">
              <h2 className="text-capitalize">Unilorin INSPIRE Award Components</h2>
              <p>
                The Unilorin INSPIRE Award is structured around three core pillars that
        ...
        <div className="container">
          ...
          <Accordion>
              ...
              <Accordion.Body>
                <ul>
                  ...
                  <li>
                    ...
                    full Unilorin INSPIRE Award will be granted upon satisfying all
            ...
            <Accordion.Item eventKey="6">
              ...
              <Accordion.Body>
                The Unilorin INSPIRE Award is tailored to accommodate postgraduate
      ...
      <div className="py-5">
        <div className="container">
          ...
          <p className="text-center">
            ...
            leadership skills. The Unilorin INSPIRE Award distinguishes participants by
