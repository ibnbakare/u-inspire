...
export const Sidebar = ({ userType, show, handleClose }) => {
    ...
    <>
      ...
      <Nav className="flex-column">
        ...
        >
          ...
          {userType === "student" ? "Internships" : "Job Postings"}
        </Nav.Link>
        {userType === "company" && (
          <>
            <Nav.Link
              onClick={() => handleNavigation("/partner/define-courses")}
              className="text-white py-3 px-4"
            >
              <Book size={18} className="me-2" />
              Define Courses
            ...
            <Nav.Link
              onClick={() => handleNavigation("/partner/communication-links")}
              className="text-white py-3 px-4"
            >
...
// import { useNavigate } from "react-router-dom";
// import { Book, Calendar, Briefcase, User, Settings } from "lucide-react";

// export const Sidebar = ({ userType }) => {
//   const navigate = useNavigate();
//   const handleNavigation = (path) => {
//     navigate(path);
//     // setExpanded(false); // Close the navbar on mobile after navigation
//   };
//   return (
//     <Nav className="flex-column">
